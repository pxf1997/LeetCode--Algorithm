...
public class P1600_ThroneInheritance {
    public static void main(String[] args) {
        //测试代码
        // Solution solution = new P1600_ThroneInheritance().new Solution();
        ThroneInheritance t = new P1600_ThroneInheritance().new ThroneInheritance("king");
        t.birth("king","andy");
        t.birth("king","bob");
