...
public class P1846_MaximumElementAfterDecreasingAndRearranging {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new P1846_MaximumElementAfterDecreasingAndRearranging().new Solution();
//        int[] arr = new int[]{100, 1, 1000};
        int[] arr = new int[]{100, 5, 1000, 11};
//        int[] arr = new int[]{2, 2, 1, 2, 1};
        int res = solution.maximumElementAfterDecrementingAndRearranging(arr);
