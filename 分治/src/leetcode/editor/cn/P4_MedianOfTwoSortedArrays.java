...
public class P4_MedianOfTwoSortedArrays {
    public static void main(String[] args) {
        ...
        double res = solution.findMedianSortedArrays(new int[]{1, 3, 5}, new int[]{2, 4, 6});
    ...
    class Solution1 {
        public double findMedianSortedArrays(int[] nums1, int[] nums2) {
            ...
            System.arraycopy(nums2, 0, nums3, 0 + nums1.length, nums2.length);
            Arrays.sort(nums3);
            ...
            if (len3 % 2 == 1) {
                ...
                double a = nums3[len3 / 2];
                double b = nums3[len3 / 2 - 1];
                return (a + b) / 2;
            }
