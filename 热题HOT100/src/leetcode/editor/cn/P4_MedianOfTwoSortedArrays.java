...
public class P4_MedianOfTwoSortedArrays {
    ...
    class Solution1 {
        ...
        public double findMedianSortedArrays(int[] nums1, int[] nums2) {
            ...
            Arrays.sort(total);
            // 奇数个:下标为0,1,2,3,4  5/2=2
            if (total.length % 2 == 1) return total[total.length / 2];
                // 偶数个:下标为0,1,2,3,4,5  6/2=3
            else return (double) (total[total.length / 2] + total[total.length / 2 - 1]) / 2;
        }
    }
    // 二分法
    class Solution {
